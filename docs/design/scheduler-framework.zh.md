---
title: "Scheduler Framework 与 Run 间亲和性"
---

# Scheduler Framework 与 Run 间亲和性
...
scheduler leader 在每个 planning cycle 中从一个 key 处理有界的 eligible Runs。集合大小和 planning time
budget 是实现配置，而不是 Run API fields。达到预算后，其余 eligible Runs 留给下一个 cycle。确定性的基础排序使用 creation timestamp
